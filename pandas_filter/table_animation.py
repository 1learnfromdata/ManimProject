...
class DataframeFilters(Scene):
    def construct(self):
        ...
        box_disapper_text1 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>  student_df</b></span>',
        ...
        self.play(GrowFromCenter(table_05), GrowFromCenter(table_04), GrowFromCenter(table_03), GrowFromCenter(table_02),
                  GrowFromCenter(table_01), GrowFromCenter(table_06),
                  # GrowFromCenter(table_00)
                  )

        table_name_text = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>NAME</b></span>',
                      0.3, GREY_A, 2.35 * UP + 5.3 * LEFT)
        self.play(Write(table_name_text))



        row_zero_group = VGroup()
        row_zero_group.add(table_00, table_04, table_05,table_06)

        # -----------row 1 -------------------


        table_10 = dataframe_rectange(width_r,height_r,r'<span font_family="monospace"><b>ANUJ</b></span>')
        ...
        table_20 = dataframe_rectange(width_r,height_r,r'<span font_family="monospace"><b>BALE</b></span>')
        ...
        row_two_group.add(table_20, table_24, table_25,table_26)

        #   -------- row 4 ---------------
        table_30 = dataframe_rectange(width_r,height_r,r'<span font_family="monospace"><b>GEORGE</b></span>')
        ...
        table_40 = dataframe_rectange(width_r,height_r,r'<span font_family="monospace"><b>JIBIN</b></span>')
        ...
        row_four_group.add(table_40, table_44, table_45,table_46)

        # --------------ROW 6 ---------------

        table_50 = dataframe_rectange(width_r,height_r,r'<span font_family="monospace"><b>JOHN</b></span>')
        ...
        table_60 = dataframe_rectange(width_r,height_r,r'<span font_family="monospace"><b>SOMAN</b></span>')
        ...
        row_six_group.add(table_60, table_64, table_65,table_66)
        ...
        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.loc[["BALE", "JIBIN", "SOMAN"], "TOTAL":]</b></span>',
                      0.25, WHITE, 0.8 * DOWN + 5  * LEFT)
        box_disapper_text2.next_to(red_arrow_fixed2, buff=0)
        ...
        highlight_row1 = dataframe_swap_scale(width_r,height_r, BLUE_D)
        highlight_row1.shift(1.7 * UP + 5.3 * LEFT)

        highlight_row2 = dataframe_swap_scale(9, height_r, BLUE_D)
        highlight_row2.shift(1.7 * UP + 3.7 * RIGHT)
        self.play(Create(highlight_row2), Create(highlight_row1), run_time=2)


        highlight_row3 = dataframe_swap_scale(width_r,height_r, BLUE_D)
        highlight_row3.shift(1 * UP + 5.3 * LEFT)

        highlight_row4 = dataframe_swap_scale(9, height_r, BLUE_D)
        highlight_row4.shift(1 * UP + 3.7 * RIGHT)
        self.play(Create(highlight_row4),Create(highlight_row3),run_time=2)  


        highlight_row5 = dataframe_swap_scale(width_r,height_r, BLUE_D)
        highlight_row5.shift(0.3 * UP + 5.3 * LEFT)

        highlight_row6 = dataframe_swap_scale(9, height_r, BLUE_D)
        highlight_row6.shift(0.3 * UP + 3.7 * RIGHT)
        self.play(Create(highlight_row6),Create(highlight_row5),run_time=2)
        self.wait(5)      
        ...
        left_tab_04.next_to(left_tab_00, buff=0)
        ...
        left_zero_group.add(left_tab_06, left_tab_05, left_tab_04, left_tab_00)

        self.play(TransformFromCopy(row_zero_group, left_zero_group), run_time=2)

        left_name_text = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>NAME</b></span>',
                      0.23, GREY_A, 1.67 * DOWN + 6.5 * LEFT)
        self.play(FadeOut(left_tab_00), FadeIn(left_name_text))

        # -----------row 1 -------------------


        left_tab_10 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>BALE</b></span>')
        left_tab_10.shift(1.95 * DOWN + 6.5 * LEFT)
        # left_tab_10.set_stroke(color=GOLD_C, opacity=0)

        left_tab_11 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>150</b></span>')
        left_tab_11.next_to(left_tab_10, buff=0)

        left_tab_12 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>21</b></span>')
        left_tab_12.next_to(left_tab_11, buff=0)

        left_tab_13 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>CHESS</b></span>')
        left_tab_13.next_to(left_tab_12, buff=0)

        left_one_group = VGroup()
        left_one_group.add(left_tab_13, left_tab_12, left_tab_11,left_tab_10)

        self.play(TransformFromCopy(row_two_group, left_one_group), run_time=2)

        # ---------- row 2 ---------------------

        left_tab_20 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>JIBIN</b></span>')
        left_tab_20.shift(2.3 * DOWN + 6.5 * LEFT)
        # left_tab_20.set_stroke(color=GOLD_C, opacity=0)

        left_tab_21 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>300</b></span>')
        left_tab_21.next_to(left_tab_20, buff=0)

        left_tab_22 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>23</b></span>')
        left_tab_22.next_to(left_tab_21, buff=0)

        left_tab_23 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>BASKETBALL</b></span>')
        left_tab_23.next_to(left_tab_22, buff=0)

        left_two_group = VGroup()
        left_two_group.add(left_tab_23, left_tab_22, left_tab_21,left_tab_20)

        self.play(TransformFromCopy(row_four_group, left_two_group), run_time=2)

        #   -------- row 4 ---------------
        left_tab_30 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>SOMAN</b></span>')
        left_tab_30.shift(2.65 * DOWN + 6.5 * LEFT)
        # left_tab_30.set_stroke(color=GOLD_C, opacity=0)

        left_tab_31 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>430</b></span>')
        left_tab_31.next_to(left_tab_30, buff=0)

        left_tab_32 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>22</b></span>')
        left_tab_32.next_to(left_tab_31, buff=0)

        left_tab_33 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>CRICKET</b></span>')
        left_tab_33.next_to(left_tab_32, buff=0)

        left_three_group = VGroup()
        left_three_group.add(left_tab_33, left_tab_32, left_tab_31,left_tab_30)

        self.play(TransformFromCopy(row_six_group, left_three_group), run_time=2)
        ...
        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.iloc[[1,3,5], 3:]</b></span>',
                      0.45, WHITE, 0.8 * DOWN + 2.5 * RIGHT)
        box_disapper_text2.next_to(red_arrow_fixed3)
        self.play(Write(box_disapper_text2))
        ...
        right_tab_04.next_to(right_tab_00, buff=0)
        ...
        right_zero_group.add(right_tab_06, right_tab_05, right_tab_04, right_tab_00)

        self.play(TransformFromCopy(row_zero_group, right_zero_group), run_time=2)

        right_name_text = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>NAME</b></span>',
                      0.23, GREY_A, 1.67 * DOWN + 0.8 * RIGHT)

        self.play(FadeOut(right_tab_00), FadeIn(right_name_text))

        # -----------row 1 -------------------


        right_tab_10 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>BALE</b></span>')
        right_tab_10.shift(1.95 * DOWN + 0.8 * RIGHT)
        # right_tab_10.set_stroke(color=GOLD_C, opacity=0)

        right_tab_11 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>150</b></span>')
        right_tab_11.next_to(right_tab_10, buff=0)

        right_tab_12 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>21</b></span>')
        right_tab_12.next_to(right_tab_11, buff=0)

        right_tab_13 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>CHESS</b></span>')
        right_tab_13.next_to(right_tab_12, buff=0)

        right_one_group = VGroup()
        right_one_group.add(right_tab_13, 
                            right_tab_12, right_tab_11,right_tab_10)

        self.play(TransformFromCopy(row_two_group, right_one_group), run_time=2)

        # ---------- row 2 ---------------------

        right_tab_20 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>JIBIN</b></span>')
        right_tab_20.shift(2.3 * DOWN + 0.8 * RIGHT)
        # right_tab_20.set_stroke(color=GOLD_C, opacity=0)

        right_tab_21 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>300</b></span>')
        right_tab_21.next_to(right_tab_20, buff=0)

        right_tab_22 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>23</b></span>')
        right_tab_22.next_to(right_tab_21, buff=0)

        right_tab_23 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>BASKETBALL</b></span>')
        right_tab_23.next_to(right_tab_22, buff=0)

        right_two_group = VGroup()
        right_two_group.add(right_tab_23, right_tab_22, 
                            right_tab_21,right_tab_20)

        self.play(TransformFromCopy(row_four_group, right_two_group), run_time=2)

        #   -------- row 4 ---------------
        right_tab_30 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>SOMAN</b></span>')
        right_tab_30.shift(2.65 * DOWN + 0.8 * RIGHT)
        # right_tab_30.set_stroke(color=GOLD_C, opacity=0)

        right_tab_31 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>430</b></span>')
        right_tab_31.next_to(right_tab_30, buff=0)

        right_tab_32 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>22</b></span>')
        right_tab_32.next_to(right_tab_31, buff=0)

        right_tab_33 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>CRICKET</b></span>')
        right_tab_33.next_to(right_tab_32, buff=0)

        right_three_group = VGroup()
        right_three_group.add(right_tab_33, 
                              right_tab_32, right_tab_31,right_tab_30)

        self.play(TransformFromCopy(row_six_group, right_three_group), run_time=2)
...
class DataframeFiltersOne(Scene):
    def construct(self):
        ...
        row_zero_group = VGroup()
        row_zero_group.add(table_00, table_04, table_05,table_03)
        ...
        row_two_group = VGroup()
        row_two_group.add(table_20, table_24, table_25,table_23)
        ...
        row_three_group = VGroup()
        row_three_group.add(table_30, table_33, table_34, table_35)
        ...
        row_four_group = VGroup()
        row_four_group.add(table_40, table_44, table_45,table_43)
        ...
        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.loc["BALE":"JIBIN","BRANCH":"AGE"]</b></span>',
                      0.27, WHITE, 0.8 * DOWN + 5  * LEFT)
        ...
        highlight_row1 = dataframe_swap_scale(width_r,1.8, BLUE_D)
        highlight_row1.shift(1.35 * UP + 5.3 * LEFT)

        highlight_row2 = dataframe_swap_scale(9, 1.8, BLUE_D)
        highlight_row2.shift(1.35 * UP + 1.9 * RIGHT)
        self.play(Create(highlight_row2), Create(highlight_row1), run_time=2)  
        self.wait(5)  
        ...
        left_tab_04 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>BRANCH</b></span>')
        left_tab_04.next_to(left_tab_00, buff=0)

        left_tab_05 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>TOTAL</b></span>')
        left_tab_05.next_to(left_tab_04, buff=0)

        left_tab_06 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>AGE</b></span>')
        left_tab_06.next_to(left_tab_05, buff=0)
        ...
        left_tab_11 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>SCIENCE</b></span>')
        left_tab_11.next_to(left_tab_10, buff=0)

        left_tab_12 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>150</b></span>')
        left_tab_12.next_to(left_tab_11, buff=0)

        left_tab_13 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>21</b></span>')
        left_tab_13.next_to(left_tab_12, buff=0)
        ...
        left_tab_30 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>GEORGE</b></span>')
        left_tab_30.shift(2.3 * DOWN + 6.5 * LEFT)
        # left_tab_30.set_stroke(color=GOLD_C, opacity=0)

        left_tab_31 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>HUMANITIES</b></span>')
        left_tab_31.next_to(left_tab_30, buff=0)

        left_tab_32 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>400</b></span>')
        left_tab_32.next_to(left_tab_31, buff=0)

        left_tab_33 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>22</b></span>')
        left_tab_33.next_to(left_tab_32, buff=0)

        left_three_group = VGroup()
        left_three_group.add(left_tab_33, left_tab_32, left_tab_31,left_tab_30)

        self.play(TransformFromCopy(row_three_group, left_three_group), run_time=2)
        ...
        left_tab_20 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>JIBIN</b></span>')
        left_tab_20.shift(2.65 * DOWN + 6.5 * LEFT)
        # left_tab_20.set_stroke(color=GOLD_C, opacity=0)

        left_tab_21 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>COMMERCE</b></span>')
        left_tab_21.next_to(left_tab_20, buff=0)

        left_tab_22 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>300</b></span>')
        left_tab_22.next_to(left_tab_21, buff=0)

        left_tab_23 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>23</b></span>')
        left_tab_23.next_to(left_tab_22, buff=0)
        ...
        self.play(FadeOut(highlight_row2), FadeOut(highlight_row1))
        ...
        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.iloc[1:3, 2:4]</b></span>',
                      0.45, WHITE, 0.8 * DOWN + 2.5 * RIGHT)
        box_disapper_text2.next_to(red_arrow_fixed3)
        self.play(Write(box_disapper_text2))
        self.wait(5) 

        highlight_row1 = dataframe_swap_scale(width_r,1.2, BLUE_D)
        highlight_row1.shift(1.5 * UP + 5.3 * LEFT)

        highlight_row2 = dataframe_swap_scale(6, 1.2, BLUE_D)
        highlight_row2.shift(1.5 * UP + 1 * RIGHT)
        self.play(Create(highlight_row2), Create(highlight_row1), run_time=2)
        self.wait(5)    
        ...
        right_tab_04 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>BRANCH</b></span>')
        right_tab_04.next_to(right_tab_00, buff=0)

        right_tab_05 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>TOTAL</b></span>')
        right_tab_05.next_to(right_tab_04, buff=0)

        right_zero_group = VGroup()
        right_zero_group.add(right_tab_05, right_tab_04, right_tab_00)
        row_zero_group.remove(table_05)
        ...
        right_tab_11 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>SCIENCE</b></span>')
        right_tab_11.next_to(right_tab_10, buff=0)

        right_tab_12 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>150</b></span>')
        right_tab_12.next_to(right_tab_11, buff=0)

        right_one_group = VGroup()
        right_one_group.add(right_tab_12, right_tab_11,right_tab_10)
        row_two_group.remove(table_25)

        self.play(TransformFromCopy(row_two_group, right_one_group), run_time=2)

        # ---------- row 2 ---------------------

        right_tab_20 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>GEORGE</b></span>')
        right_tab_20.shift(2.3 * DOWN + 0.8 * RIGHT)
        # right_tab_20.set_stroke(color=GOLD_C, opacity=0)

        right_tab_21 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>HUMANITIES</b></span>')
        right_tab_21.next_to(right_tab_20, buff=0)

        right_tab_22 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>400</b></span>')
        right_tab_22.next_to(right_tab_21, buff=0)

        right_two_group = VGroup()
        right_two_group.add(right_tab_22, 
                            right_tab_21,right_tab_20)

        row_three_group.remove(table_35)

        self.play(TransformFromCopy(row_three_group, right_two_group), run_time=2)
...
# --------------------------another new class staarts here ----------------------------------------

class DataframeFiltersTwo(Scene):
    def construct(self):
        ...
        row_zero_group = VGroup()
        row_zero_group.add(table_00, table_04, table_02,table_03)
        ...
        row_three_group = VGroup()
        row_three_group.add(table_30, table_33, table_34, table_32)
        ...
        row_four_group = VGroup()
        row_four_group.add(table_40, table_44, table_42,table_43)
        ...
        row_six_group = VGroup()
        row_six_group.add(table_60, table_62, table_63,table_64)
        ...
        red_arrow_fixed2 = currentTextPositionMarkupWithout(r'<span font_family="monospace">>>> </span>',
                      0.27, WHITE, 0.8 * DOWN + 6.8  * LEFT)
        red_arrow_fixed2.set_color(RED_D)
        self.play(Write(red_arrow_fixed2))

        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.loc[student_df["TOTAL"] > 200, "NAME":"TOTAL"]</b></span>',
                      0.24, WHITE, 0.8 * DOWN + 5  * LEFT)
        box_disapper_text2.next_to(red_arrow_fixed2, buff=0.1)
        self.play(Write(box_disapper_text2))
        ...
        highlight_row1 = dataframe_swap_scale(width_r,1.2, BLUE_D)
        highlight_row1.shift(1.2 * UP + 5.3 * LEFT)

        highlight_row2 = dataframe_swap_scale(9, 1.2, BLUE_D)
        highlight_row2.shift(1.2 * UP + 0.1 * RIGHT)
        self.play(Create(highlight_row2), Create(highlight_row1), run_time=2)

        highlight_row3 = dataframe_swap_scale(width_r,height_r, BLUE_D)
        highlight_row3.shift(0.3 * UP + 5.3 * LEFT)

        highlight_row4 = dataframe_swap_scale(9, height_r, BLUE_D)
        highlight_row4.shift(0.3 * UP + 0.1 * RIGHT)
        self.play(Create(highlight_row3), Create(highlight_row4), run_time=2)
        self.wait(5)      
        ...
        left_tab_04 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>NAME</b></span>')
        left_tab_04.next_to(left_tab_00, buff=0)

        left_tab_05 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>BRANCH</b></span>')
        left_tab_05.next_to(left_tab_04, buff=0)

        left_tab_06 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>TOTAL</b></span>')
        left_tab_06.next_to(left_tab_05, buff=0)
        ...
        left_tab_10 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>GEORGE</b></span>')
        left_tab_10.shift(1.95 * DOWN + 6.5 * LEFT)
        # left_tab_10.set_stroke(color=GOLD_C, opacity=0)

        left_tab_11 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>GEORGE</b></span>')
        left_tab_11.next_to(left_tab_10, buff=0)

        left_tab_12 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>HUMANITIES</b></span>')
        left_tab_12.next_to(left_tab_11, buff=0)

        left_tab_13 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>400</b></span>')
        left_tab_13.next_to(left_tab_12, buff=0)

        left_one_group = VGroup()
        left_one_group.add(left_tab_13, left_tab_12, left_tab_11,left_tab_10)

        self.play(TransformFromCopy(row_three_group, left_one_group), run_time=2)

        # ---------- row 2 ---------------------

        left_tab_30 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>JIBIN</b></span>')
        left_tab_30.shift(2.3 * DOWN + 6.5 * LEFT)
        # left_tab_30.set_stroke(color=GOLD_C, opacity=0)

        left_tab_31 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>JIBIN</b></span>')
        left_tab_31.next_to(left_tab_30, buff=0)

        left_tab_32 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>COMMERCE</b></span>')
        left_tab_32.next_to(left_tab_31, buff=0)

        left_tab_33 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>300</b></span>')
        left_tab_33.next_to(left_tab_32, buff=0)

        left_three_group = VGroup()
        left_three_group.add(left_tab_33, left_tab_32, left_tab_31,left_tab_30)

        self.play(TransformFromCopy(row_four_group, left_three_group), run_time=2)

        

        #   -------- row 4 ---------------

        left_tab_20 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>SOMAN</b></span>')
        left_tab_20.shift(2.65 * DOWN + 6.5 * LEFT)
        # left_tab_20.set_stroke(color=GOLD_C, opacity=0)

        left_tab_21 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>SOMAN</b></span>')
        left_tab_21.next_to(left_tab_20, buff=0)

        left_tab_22 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>HUMANITIES</b></span>')
        left_tab_22.next_to(left_tab_21, buff=0)

        left_tab_23 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>430</b></span>')
        left_tab_23.next_to(left_tab_22, buff=0)

        left_two_group = VGroup()
        left_two_group.add(left_tab_23, left_tab_22, left_tab_21,left_tab_20)

        self.play(TransformFromCopy(row_six_group, left_two_group), run_time=2)
        self.wait(5)
        ...
        red_arrow_fixed3 = currentTextPositionMarkupWithout(r'<span font_family="monospace">>>> </span>',
                      0.24, WHITE, 0.8 * DOWN + 0.75 * RIGHT)
        red_arrow_fixed3.set_color(RED_D)
        self.play(Write(red_arrow_fixed3))

        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.iloc[(student_df["TOTAL"] > 200).values, 1:4]</b></span>',
                      0.24, WHITE, 0.8 * DOWN + 2.5 * RIGHT)
        box_disapper_text2.next_to(red_arrow_fixed3, buff=0.1)
        self.play(Write(box_disapper_text2))
        ...
        right_tab_04 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>NAME</b></span>')
        right_tab_04.next_to(right_tab_00, buff=0)

        right_tab_05 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>BRANCH</b></span>')
        right_tab_05.next_to(right_tab_04, buff=0)

        right_tab_06 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>TOTAL</b></span>')
        right_tab_06.next_to(right_tab_05, buff=0)

        right_zero_group = VGroup()
        right_zero_group.add(right_tab_05, right_tab_04, right_tab_00, right_tab_06)
        ...
        right_tab_10 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>GEORGE</b></span>')
        right_tab_10.shift(1.95 * DOWN + 0.8 * RIGHT)
        # right_tab_10.set_stroke(color=GOLD_C, opacity=0)

        right_tab_11 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>GEORGE</b></span>')
        right_tab_11.next_to(right_tab_10, buff=0)

        right_tab_12 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>HUMANITIES</b></span>')
        right_tab_12.next_to(right_tab_11, buff=0)

        right_tab_13 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>400</b></span>')
        right_tab_13.next_to(right_tab_12, buff=0)

        right_one_group = VGroup()
        right_one_group.add(right_tab_12, right_tab_11,right_tab_10, right_tab_13)

        self.play(TransformFromCopy(row_three_group, right_one_group), run_time=2)
        ...
        right_tab_21 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>JIBIN</b></span>')
        right_tab_21.next_to(right_tab_20, buff=0)

        right_tab_22 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>COMMERCE</b></span>')
        right_tab_22.next_to(right_tab_21, buff=0)

        right_tab_23 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>300</b></span>')
        right_tab_23.next_to(right_tab_22, buff=0)

        right_two_group = VGroup()
        right_two_group.add(right_tab_22, 
                            right_tab_21,right_tab_20, right_tab_23)
        ...
        right_tab_31 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>SOMAN</b></span>')
        right_tab_31.next_to(right_tab_30, buff=0)

        right_tab_32 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>HUMANITIES</b></span>')
        right_tab_32.next_to(right_tab_31, buff=0)

        right_tab_33 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>430</b></span>')
        right_tab_33.next_to(right_tab_32, buff=0)

        right_three_group = VGroup()
        right_three_group.add(right_tab_32, 
                            right_tab_31,right_tab_30, right_tab_33)
...
class DataframeFiltersThree(Scene):
    def construct(self):
        ...
        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.loc[lambda x:x["AGE"] > 22]</b></span>',
                      0.35, WHITE, 0.8 * DOWN + 5  * LEFT)
        box_disapper_text2.next_to(red_arrow_fixed2, buff=0.1)
        self.play(Write(box_disapper_text2))
        self.wait(5)
        ...
        highlight_row3 = dataframe_swap_scale(21,height_r, BLUE_D)
        highlight_row3.shift(2.05 * UP + 0.1 * RIGHT)

        highlight_row4 = dataframe_swap_scale(21, height_r, BLUE_D)
        highlight_row4.shift(1 * UP + 0.1 * RIGHT)
        self.play(Create(highlight_row4),Create(highlight_row3),run_time=2)
        self.wait(5)    
        ...
        left_tab_10 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>ANUJ</b></span>')
        left_tab_10.shift(1.95 * DOWN + 6.5 * LEFT)
        # left_tab_10.set_stroke(color=GOLD_C, opacity=0)
        ...
        left_tab_40 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>JIBIN</b></span>')
        left_tab_40.shift(2.3 * DOWN + 6.5 * LEFT)
        ...
        # self.play(TransformFromCopy(row_six_group, left_three_group), run_time=1)
        ...
        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.iloc[lambda x:(x["AGE"] > 22).values]</b></span>',
                      0.3, WHITE, 0.8 * DOWN + 2.5 * RIGHT)
        box_disapper_text2.next_to(red_arrow_fixed3, buff=0.1)
        self.play(Write(box_disapper_text2))
        self.wait(5)  
        ...
        right_tab_10 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>ANUJ</b></span>')
        right_tab_10.shift(1.95 * DOWN + 0.8 * RIGHT)
        ...
        right_tab_30 = dataframe_rectange_s(width_s,height_s,r'<span font_family="monospace"><b>JIBIN</b></span>')
        right_tab_30.shift(2.3 * DOWN + 0.8 * RIGHT)
        # right_tab_30.set_stroke(color=GOLD_C, opacity=0)

        right_tab_31 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>104</b></span>')
        right_tab_31.next_to(right_tab_30, buff=0)

        right_tab_32 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>JIBIN</b></span>')
        right_tab_32.next_to(right_tab_31, buff=0)

        right_tab_33 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>COMMERCE</b></span>')
        right_tab_33.next_to(right_tab_32, buff=0)

        right_tab_34 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>300</b></span>')
        right_tab_34.next_to(right_tab_33, buff=0)

        right_tab_35 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>23</b></span>')
        right_tab_35.next_to(right_tab_34, buff=0)

        right_tab_36 = dataframe_rectange_s(width_s, height_s, r'<span font_family="monospace"><b>BASKETBALL</b></span>')
        right_tab_36.next_to(right_tab_35, buff=0)

        right_two_group = VGroup()
        right_two_group.add(right_tab_36, right_tab_35, right_tab_34, right_tab_33, 
                              right_tab_32, right_tab_31,right_tab_30)
...
class DataframeFiltersFour(Scene):
    def construct(self):
        ...
        top_text_replace = currentTextPositionMarkupWithout(f'<span font_family="monospace"><b>.at and .iat</b></span>',
                      0.5, TEAL_A, 3.7 * UP + 0.6 * LEFT)
        top_text_replace.next_to(top_disapper_text)
        self.play(Write(top_text_replace))
        ...
        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.at["GEORGE", "BRANCH"]</b></span>',
                      0.4, WHITE, 0.8 * DOWN + 5  * LEFT)
        box_disapper_text2.next_to(red_arrow_fixed2, buff=0.1)
        self.play(Write(box_disapper_text2))
        ...
        highlight_row3 = dataframe_swap_scale(width_r,height_r, BLUE_D)
        highlight_row3.shift(1.35 * UP + 0.1 * RIGHT) 
        self.wait(5) 

        # # ----------------small dataframe -------------------

        loc_result = """'HUMANITIES'"""
        
        loc_result_vary = currentTextPositionMarkupWithout(f'<span font_family="monospace"><b>{loc_result}</b></span>',
                      0.45, GREY_A, 1.8 * DOWN + 5  * LEFT)

        self.play(Create(highlight_row3),run_time=1)

        self.play(TransformFromCopy(table_33, loc_result_vary), run_time=2)
        ...
        box_disapper_text2 = currentTextPositionMarkupWithout(r'<span font_family="monospace"><b>student_df.iat[2, 2]</b></span>',
                      0.45, WHITE, 0.8 * DOWN + 2.5 * RIGHT)
        box_disapper_text2.next_to(red_arrow_fixed3, buff=0.1)
        self.play(Write(box_disapper_text2))
        self.wait(5)

        iloc_result = """'HUMANITIES'"""
        
        iloc_result_vary = currentTextPositionMarkupWithout(f'<span font_family="monospace"><b>{iloc_result}</b></span>',
                      0.45, GREY_A, 1.8 * DOWN + 3  * RIGHT)
        self.wait(0.5)

        self.play(TransformFromCopy(table_33, iloc_result_vary), run_time=2)
